...
public class CommentsController {
	...
	public Comments addComments(@PathVariable("titleId") int titleId,@PathVariable("userId") int userId,
	...
	@RequestMapping(value = "/update/{titleId}/{userId}", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value="Update Comment", notes="Update an existing Comment")
	@ApiResponses(value={ @ApiResponse(code=200, message="Success"),
						  @ApiResponse(code=400, message="Bad Request"),
						  @ApiResponse(code=404, message="Not Found"),
						  @ApiResponse(code=500, message="Internal Server Error")})
	public Comments updateComments(@PathVariable("titleId") int titleId,@PathVariable("userId") int userId,
			@RequestBody Comments comment)
	...
	@RequestMapping(value = "/delete/{titleId}/{userId}/{commentId}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value="Delete Comment", notes="Delete an existing Comment")
	@ApiResponses(value={ @ApiResponse(code=200, message="Success"),
		     			  @ApiResponse(code=404, message="Not Found"),
		     			  @ApiResponse(code=500, message="Internal Server Error")})
	public Comments deleteComments(@PathVariable("titleId") int titleId,@PathVariable("userId") int userId,
	...
	@ApiResponses(value={ @ApiResponse(code=200, message="Success"),
						  @ApiResponse(code=404, message="Not Found"),
						  @ApiResponse(code=500, message="Internal Server Error")})
	public List<Comments> getCommentsForTitle(@PathVariable("titleId") int titleId)throws TitleNotFoundException {
